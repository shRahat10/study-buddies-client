...
const Footer = () => {
    ...
    return (
        <div className="py-10 mt-16 text-white bg-transparent">
            <div className="flex flex-col md:items-start items-center">
                    <img src={logo} className="font-bold text-3xl w-56" alt="Logo"></img>
                    <p className="text-lg mt-2">Engage. Collaborative. Support.</p>
            </div>
            ...
            <hr />
            <p className="text-center mt-8">© 2024 Study Buddies. All rights reserved.</p>
        </div>
