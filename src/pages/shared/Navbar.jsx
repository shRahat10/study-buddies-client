                ...
                </li>
                {
                    loading ? (
                        ...
                        <span className="flex gap-2">
                            <Link to={"/login"}>
                                <button className="bg-primary text-white text-xs md:text-base py-2 px-4 rounded hover:bg-transparent hover:outline hover:outline-1 hover:outline-primary hover:text-primary transition duration-300 ease-in-out">
                                    Login
                                </button>
                            </Link>
                            <Link to={"/register"}>
